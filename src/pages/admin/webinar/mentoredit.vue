  ...
  <div>
    ...
    <div class="row">
            ...
            <div class="col-md">
              ...
              <textarea v-model="profile.mentor_profile"  id="answer" name="answer" class="form-control" :disabled="edit === 0"></textarea>
            </div>
            <div class="col">
    ...
    <div class="row">
           ...
           <div class="col">
            <button class="btn btn-success" type="button" @click="delete1">Delete Mentor</button>
           </div>
    </div>
    <hr>
  </div>
